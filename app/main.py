...
#   /tokens  the raw vendored tokens/*.css, loaded directly (no bundle) by
#            app/templates/login.html, which stays a plain Jinja template
...
app.mount("/tokens", StaticFiles(directory=_STATIC_DIR / "tokens"), name="tokens")
